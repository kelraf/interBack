    ...
    if sale_quantity == nil do
      ...
      if storeproduct_id == nil do
        ...
        cond do
          ...
          true ->
            s_changeset = storeproduct |> IO.inspect(label: "XXXXXXXXXXXXXXXXXXXXXXXX 2") |> StoreProduct.changeset(%{quantity: Map.get(storeproduct, :quantity) - sale_quantity}) |> IO.inspect(label: "XXXXXXXXXXXXXXXXXXXXXXXX 3") |> delete_change(:new_warehouseproduct_changeset) |> IO.inspect(label: "XXXXXXXXXXXXXXXXXXXXXXXX 35")
