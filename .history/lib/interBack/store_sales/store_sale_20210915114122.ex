    ...
    if sale_quantity == nil do
      ...
      if storeproduct_id == nil do
        ...
        cond do
          ...
          true ->
            s_changeset = storeproduct |> StoreProduct.changeset(%{quantity: Map.get(storeproduct, :quantity) - sale_quantity}) |> IO.inspect(label: "XXXXXXXXXXXXXX 2") 
            # s_changeset = storeproduct |> IO.inspect(label: "XXXXXXXXXXXXXXXXXXXXXXXX 2") |> StoreProduct.changeset(%{quantity: Map.get(storeproduct, :quantity) - sale_quantity}) |> IO.inspect(label: "XXXXXXXXXXXXXXXXXXXXXXXX 3")
