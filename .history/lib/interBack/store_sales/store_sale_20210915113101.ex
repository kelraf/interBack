  ...
  defp calcSale(changeset) do
    ...
    if sale_quantity == nil do
      ...
      if storeproduct_id == nil do
        ...
        storeproduct = Repo.get_by(StoreProduct, id: storeproduct_id) |> IO.inspect
        cond do
          ...
          true ->  
            s_changeset = storeproduct |> IO.inspect |> StoreProduct.changeset(%{quantity: Map.get(storeproduct, :quantity) - sale_quantity}) |> IO.inspect
